...
# MySQL 데이터베이스 연결
engine = create_engine('mysql+pymysql://root:password@localhost/crypto_db')
...
ax1.set_title('비트코인 가격', fontproperties=font_prop)  
...
ax2.set_title('비트코인 시세 예측 (2025)', fontproperties=font_prop)  
